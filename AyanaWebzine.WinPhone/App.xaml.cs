...
namespace AyanaWebzine.WinPhone
{
    /// <summary>
    ...
    public sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            // Lecture des articles enregistrées
            await FetchDataStoreArticles();
            ...
            if (rootFrame.Content == null)
            {
                ...
                // paramètre
                if (!rootFrame.Navigate(typeof(AyanaWebzine.WinPhone.Views.MainPage), e.Arguments))
                {
        ...
        private async Task FetchDataStoreArticles()
        {
            DataStore dataStore = DataStore.GetInstance();

            string dataFilename = "categories";

            var localStorage = ApplicationData.Current.LocalFolder;
            var file = await localStorage.CreateFileAsync(dataFilename, CreationCollisionOption.OpenIfExists);
            ...
            if (file != null)
            {
                ...
                {
                    var data = serializer.ReadObject(reader) as IEnumerable<Category>;
                    if (data != null)
                        dataStore.Categories = new ObservableCollection<Category>(data);
                }
            }
        }  
    }
